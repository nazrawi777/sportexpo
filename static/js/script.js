    ...
    $(".time-countdown").each(function () {
      ...
      $this.countdown(finalDate, function (event) {
        var $this = $(this).html(
          event.strftime(
            "" +
              '<div class="counter-column"><span class="count">%D</span>D</div> ' +
              '<div class="counter-column"><span class="count">%H</span>H</div>  ' +
              '<div class="counter-column"><span class="count">%M</span>M</div>  ' +
              '<div class="counter-column"><span class="count">%S</span>S</div>',
          ),
        );
      });
    });
